    ...
    <>
      <header className="nav">
        <Link className="brand" href="/" aria-label="AYUSHPICKS home">
          <img className="brandLogo" src="/ayushpicks-logo-transparent.png" alt="AYUSHPICKS" />
        </Link>
      ...
      <style jsx global>{`
        .brandLogo{display:block;width:132px;height:38px;object-fit:contain;object-position:left center}
        @media(max-width:650px){.brandLogo{width:116px;height:34px}}
      `}</style>
    </>
  )
}
