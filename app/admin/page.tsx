...
const emptyForm = { name:'', affiliate_url:'', image_url:'', price:'', old_price:'', category_id:'', short_description:'', why_picked:'', published:false, featured:false }
...
export default function Admin() {
  ...
  function startEdit(product:any) {
    ...
    setForm({
      ...
      short_description: product.short_description || '', why_picked: product.why_picked || '', published: !!product.published, featured: !!product.featured,
    })
  ...
  async function save() {
    ...
    const payload = {
      ...
      why_picked: form.why_picked.trim() || null, published: form.published, featured: form.featured, store:'Amazon',
    }
