...
export default async function ProductDetail({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <PageShell title={product.name} kicker={product.store || 'PRODUCT PICK'}>
    ...
    <div className="affiliateNote">AYUSHPICKS may earn a commission from qualifying purchases made through affiliate links. This does not change the price you pay.</div>
  </PageShell>
}
